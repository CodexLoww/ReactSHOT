    ...
    <>
      <div className="relative bg-white w-full h-[1023px] overflow-hidden text-left text-xl text-gray-200 font-poppins">
        ...
        <div className="absolute top-[0px] left-[0px] bg-black w-72 h-[1024px] overflow-hidden text-base text-lightgray">
          ...
          <div
            className="absolute top-[138px] left-[30px] font-medium cursor-pointer"
          ...
          <img
            ...
            src="/vector-4.svg"
          />
          <div className="absolute top-[209px] left-[14px] rounded-mini bg-gray-500 w-[260px] h-[50px] overflow-hidden text-white">
            <div className="absolute top-[13px] left-[16px] font-semibold">
              Settings
            </div>
          </div>
        </div>
