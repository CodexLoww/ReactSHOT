...
import ISORDER from "../components/i-s-o-r-d-e-r";
import PortalPopup from "../components/portal-popup";
import { useRouter } from "next/router";

const WITHADDEDITEMAdmin = () => {
  const [isISORDEROpen, setISORDEROpen] = useState(false);
  ...
  const openISORDER = useCallback(() => {
    setISORDEROpen(true);
  }, []);

  const closeISORDER = useCallback(() => {
    ...
    <>
      <div className="relative bg-white w-full h-[1023px] overflow-hidden text-left text-lg text-lightgray font-poppins">
          ...
          <div className="absolute top-[80px] left-[16px] rounded-mini bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25),_0px_101px_28px_rgba(0,_0,_0,_0),_0px_65px_26px_rgba(0,_0,_0,_0.01),_0px_36px_22px_rgba(0,_0,_0,_0.03),_0px_16px_16px_rgba(0,_0,_0,_0.05),_0px_4px_9px_rgba(0,_0,_0,_0.06),_0px_0px_0px_rgba(0,_0,_0,_0.06)] w-[1000px] h-[380px] overflow-x-auto text-base text-darkslategray-200">
            <div className="absolute top-[19px] left-[23px] w-[237px] h-[157px]">
              <div className="absolute top-[14px] left-[37px] rounded-6xl bg-whitesmoke w-[200px] h-[134px] overflow-hidden">
                ...
                <div className="absolute top-[93px] left-[119px] text-mini font-semibold inline-block w-2.5">
                  0
                </div>
                <img
                  className="absolute top-[89px] left-[73px] rounded-lg w-[34px] h-[30px] overflow-hidden"
                  alt=""
                  src="/frame-25.svg"
                />
                <img
                  className="absolute top-[89px] left-[141px] rounded-lg w-[34px] h-[30px] overflow-hidden"
                  alt=""
                  src="/frame-26.svg"
                />
              </div>
        ...
        <div className="absolute top-[0px] left-[0px] bg-black w-72 h-[1024px] overflow-hidden text-base">
          ...
          <div className="absolute top-[170px] left-[14px] rounded-mini bg-gray-500 w-[260px] h-[50px] overflow-hidden text-white">
        ...
        <div className="absolute top-[0px] left-[1321px] bg-black w-[434px] h-[1024px] overflow-hidden text-3xl">
          <div className="absolute top-[170px] left-[7px] rounded-mini bg-gray-400 w-[421px] h-[174px] overflow-hidden text-white">
            <div className="absolute top-[26px] left-[20px] rounded-mini bg-darkslategray-200 w-[380px] h-[120px] overflow-hidden">
              <div className="absolute top-[24px] left-[32px] font-semibold">
                Iced Coffee
              </div>
              <div className="absolute top-[30px] left-[293px] text-base font-medium text-whitesmoke inline-block w-[63px]">
                ₱ 120.00
              </div>
              <div className="absolute top-[57px] left-[32px] font-semibold">
                Mocha
              </div>
              <div className="absolute top-[63px] left-[293px] text-base font-medium text-whitesmoke inline-block w-[70px]">
                ₱ 130.00
              </div>
            </div>
          </div>
          <div className="absolute top-[0px] left-[0px] bg-gray-500 w-[434px] h-[104px] overflow-hidden">
          ...
          <div className="absolute top-[122px] left-[40px] text-xl font-semibold">
            Orders
          </div>
          <div className="absolute top-[602px] left-[6px] rounded-mini bg-gray-500 w-[421px] h-[220px] overflow-hidden text-xl">
            <div className="absolute top-[35px] left-[34px] font-semibold">
              Subtotal
            </div>
            <div className="absolute top-[35px] left-[295px]">₱ 250.00</div>
            <div className="absolute top-[73px] left-[295px]">-</div>
          ...
          <div className="absolute top-[867px] left-[6px] rounded-mini bg-gray-500 w-[421px] h-[152px] overflow-hidden text-mini">
            <div
              className="absolute top-[84px] left-[64px] rounded-3xs bg-gray-200 w-[293px] h-[47px] overflow-hidden cursor-pointer"
              onClick={openISORDER}
            >
          ...
          <div className="absolute top-[761px] left-[300px] text-5xl">
            ₱ 250.00
          </div>
        </div>
      ...
      {isISORDEROpen && (
        <PortalPopup
          ...
          placement="Centered"
          onOutsideClick={closeISORDER}
        >
          <ISORDER onClose={closeISORDER} />
        </PortalPopup>
      )}
    </>
  );
...
export default WITHADDEDITEMAdmin;
